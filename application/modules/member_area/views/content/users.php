					...
					<div class="col-md-8">
						...
						<div class="card" data-animation="fadeIn">
							...
							<div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
								...
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									<a href="<?php echo base_url('member_area/users/create'); ?>" class="btn bg-teal"><i class="icon-user-plus mr-2"></i> Create User</a>
								</div>
							</div>
                        ...
                        if(response.status == 200){
							...
							$.each(response.responseJSON.data, function(k,v){
								...
								$.each(v.data, function(x,y){
									...
									if(v.id == instansi_id){
									tbody +='<li><a href="'+BaseUrl+'skpd/users/view/'+y.id+'" class="btn btn-link">Open Detail</a></li></ul>';
									}
									tbody +='</div></div></li>';
								});
							});
