										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-6">
													...
													<input name="type" type="hidden" value="<?php echo $this->session->userdata('instansi_id');?>" class="form-control">
					...
					<div class="col-sm-4">
								...
								<div class="card bg-warning text-center">
									...
									<div class="card-body small">
										 ...
										 1. Instansi hanya dapat melakukan registrasi untuk login ke instansi terkait.<br><br> 2. Sistem akan otomatis mencatat setiap aktifitas user untuk menghindari hal-hal yang tidak diinginkan
										 </p>
									</div>
								</div>
								<!-- /available hours -->
							...
							complete: function(response){                
							  if(response.status == 201){
								  ...
								  swal({
										...
										window.location.replace(BaseUrl+'member_area/users');
										}
									}); 
