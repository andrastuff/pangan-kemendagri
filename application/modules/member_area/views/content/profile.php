										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-6">
													...
													<input name="nama" type="text" value="<?php echo $this->session->userdata('full_name');?>" class="form-control">
												</div>
												<div class="col-md-6">
													<label>Address</label>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-12">
													...
													<input type="text" readonly="readonly"  value="<?php echo $this->session->userdata('auth_key');?>" class="form-control">
												</div>
											</div>
										</div>
